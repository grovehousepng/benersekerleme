            ...
            <div style={{ display: "flex", gap: 16, flexWrap: "wrap", marginTop: 10 }}>
              <a href="https://www.bubilet.com.tr/konya/etkinlik/konya-color-fest"
                ...
                onClick={() => {
                  if (typeof window !== "undefined") {
                    if ((window as any).fbq) {
                      (window as any).fbq('track', 'InitiateCheckout', { value: 600.00, currency: 'TRY' });
                    }
                    if ((window as any).ttq) {
                      (window as any).ttq.track('InitiateCheckout', { value: 600.00, currency: 'TRY' });
                    }
                    if ((window as any).gtag) {
                      (window as any).gtag('event', 'begin_checkout', {
                        value: 600.00, currency: 'TRY',
                        items: [{ item_id: 'colorfest_ticket', item_name: 'ColorFest Konya Bilet', price: 600.00, quantity: 1 }]
                      });
                      (window as any).gtag('event', 'ticket_click', {
                        event_category: 'Engagement', event_label: 'Bubilet Ticket Click', value: 600.00, currency: 'TRY'
                      });
                    }
                  }
                }}
