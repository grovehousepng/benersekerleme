...
export const categories: Category[] = [
  {
    ...
    heroImage: '/images/categories/seker.avif',
    color: 'rose',
    accentHex: '#C9525A',
  },
  {
    ...
    heroImage: '/images/categories/lokum.avif',
    color: 'rose',
    accentHex: '#C9525A',
  },
  {
    ...
    heroImage: '/images/categories/cezerye.avif',
    color: 'amber',
    accentHex: '#C97A3A',
  },
  {
    ...
    heroImage: '/urunler/cok-satanlar/karisik-meyve-aromali-seker.avif',
    color: 'rose',
    accentHex: '#C9525A',
  },
];
